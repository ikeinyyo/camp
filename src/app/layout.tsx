...
import { getSafeSectionAuthentication, getSafeSectionAvailability } from "@/lib/sections";
...
export default async function RootLayout({
  ...
  const [enabledSections, sectionAuthentication] = await Promise.all([getSafeSectionAvailability(), getSafeSectionAuthentication()]);
